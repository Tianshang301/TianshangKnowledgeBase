...
```mermaid
graph TD
  A["管理科学<br/>Management Science"] --> B["工商管理<br/>Business Admin."]
  A --> C["管理科学与工程<br/>Mgmt Sci & Eng."]
  A --> D["公共管理<br/>Public Admin."]
  A --> E["图书情报与档案管理<br/>LIS & Archives"]
  B --> F["市场营销<br/>Marketing"]
  B --> G["财务/会计<br/>Finance/Accounting"]
  B --> H["人力资源<br/>HR Management"]
  B --> I["战略管理<br/>Strategic Mgmt"]
  C --> J["运筹学<br/>Operations Research"]
  C --> K["供应链管理<br/>SCM"]
  C --> L["项目管理<br/>PM"]
  C --> M["信息系统<br/>MIS"]
  D --> N["公共政策<br/>Public Policy"]
  D --> O["公共财政<br/>Public Finance"]
  D --> P["电子政务<br/>E-Government"]
  E --> Q["信息组织<br/>Info Organization"]
  E --> R["知识管理<br/>KM"]
  E --> S["档案学<br/>Archival Sci"]
  style A fill:#1e6f5c,color:#fff
  style B fill:#289672,color:#fff
  style C fill:#289672,color:#fff
  style D fill:#289672,color:#fff
  style E fill:#289672,color:#fff
```
...
graph LR
  ...
  style A fill:#1e6f5c,color:#fff
  style E fill:#0d3b2e,color:#fff
  style H fill:#0d3b2e,color:#fff
```
