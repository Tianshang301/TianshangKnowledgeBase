...
```mermaid
graph TD
    A[原始印欧语<br/>Proto-Indo-European] --> B[日耳曼语族<br/>Germanic]
    A --> C[罗曼语族<br/>Romance]
    A --> D[斯拉夫语族<br/>Slavic]
    A --> E[印度-伊朗语族<br/>Indo-Iranian]
    B --> B1[英语 English]
    B --> B2[德语 German]
    C --> C1[法语 French]
    C --> C2[西班牙语 Spanish]
...
| 凯尔特语族 | 爱尔兰语、威尔士语、布列塔尼语 | 不列颠群岛、法国布列塔尼 | VSO 词序、辅音交替 |
...
```mermaid
graph TD
    A[世界主要语系<br/>Major Language Families] --> B[非洲<br/>Africa]
    A --> C[亚欧大陆<br/>Eurasia]
    A --> D[美洲<br/>Americas]
    A --> E[大洋洲<br/>Oceania]
    B --> B1[尼日尔-刚果语系<br/>Niger-Congo]
    B --> B2[亚非语系<br/>Afro-Asiatic]
    B --> B3[尼罗-撒哈拉语系<br/>Nilo-Saharan]
    B --> B4[科依桑语系<br/>Khoisan]
    C --> C1[印欧语系<br/>Indo-European]
    C --> C2[汉藏语系<br/>Sino-Tibetan]
    C --> C3[乌拉尔语系<br/>Uralic]
    C --> C4[阿尔泰语系（存疑）<br/>Altaic]
    C --> C5[南亚语系<br/>Austroasiatic]
    D --> D1[纳-德内语系<br/>Na-Dene]
    D --> D2[犹他-阿兹特克语系<br/>Uto-Aztecan]
    D --> D3[阿尔冈昆语系<br/>Algonquian]
    E --> E1[南岛语系<br/>Austronesian]
    E --> E2[巴布亚诸语<br/>Papuan]
    E --> E3[澳大利亚原住民诸语<br/>Australian]
```
