...
```mermaid
graph TD
    A[语言消亡动因<br/>Causes of Language Death] --> B[政治因素<br/>Political Factors]
    A --> C[经济因素<br/>Economic Factors]
    A --> D[社会文化因素<br/>Socio-cultural Factors]
    A --> E[教育因素<br/>Educational Factors]
    B --> B1[语言政策压制<br/>Suppressive Language Policy]
    B --> B2[殖民历史遗留<br/>Colonial Legacy]
    B --> B3[民族国家建构<br/>Nation-state Building]
    C --> C1[城市化与迁移<br/>Urbanization]
    C --> C2[劳动力市场排斥<br/>Labor Market Exclusion]
    C --> C3[经济发展不平衡<br/>Uneven Development]
    D --> D1[主流媒体主导<br/>Mainstream Media Dominance]
    D --> D2[宗教传播语言<br/>Religious Language Spread]
    D --> D3[跨族婚姻<br/>Interethnic Marriage]
    E --> E1[单语教育体制<br/>Monolingual Education]
    E --> E2[师资与教材匮乏<br/>Lack of Teachers and Materials]
    E --> E3[母语教育缺位<br/>Absence of Mother-tongue Education]
...
```mermaid
graph LR
    A[语言权利<br/>Linguistic Rights] --> B[个人权利<br/>Individual Rights]
    A --> C[集体权利<br/>Collective Rights]
    B --> B1[私人场合使用母语<br/>Private Use]
    B --> B2[姓名权与文化表达<br/>Name Rights and Expression]
    B --> B3[宗教信仰使用<br/>Religious Use]
    C --> C1[法庭口译与司法语言<br/>Court Interpretation]
    C --> C2[母语教育与师资<br/>Mother-tongue Education]
    C --> C3[公共标识与行政语言<br/>Public Signage]
    C --> C4[广播电视与新媒体<br/>Broadcasting and New Media]
    C --> C5[公共服务获取<br/>Access to Public Services]
...
```mermaid
graph TD
    A[语言生态系统<br/>Linguistic Ecosystem] --> B[自然环境<br/>Physical Environment]
    A --> C[社会环境<br/>Social Environment]
    A --> D[心理环境<br/>Psychological Environment]
    B --> B1[地理隔离与地形<br/>Geographic Isolation]
    B --> B2[气候与生计方式<br/>Climate and Livelihood]
    B --> B3[生物多样性关联<br/>Biodiversity Correlation]
    C --> C1[政治体制与语言政策<br/>Political Regime]
    C --> C2[经济结构与全球化<br/>Economic Structure]
    C --> C3[教育制度<br/>Education System]
    D --> D1[语言态度与语言忠诚<br/>Language Attitudes]
    D --> D2[身份认同与族群意识<br/>Identity]
    D --> D3[语言安全感<br/>Linguistic Security]
