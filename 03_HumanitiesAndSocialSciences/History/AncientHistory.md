...
```mermaid
graph TD
    A[古代文明<br/>Ancient Civilizations] --> B[美索不达米亚<br/>Mesopotamia]
    A --> C[古埃及<br/>Ancient Egypt]
    A --> D[古印度<br/>Ancient India]
    A --> E[古代中国<br/>Ancient China]
    A --> F[中美洲<br/>Mesoamerica]
    A --> G[波斯<br/>Persia]
    B --> B1[苏美尔<br/>Sumer]
    B --> B2[阿卡德<br/>Akkad]
    B --> B3[巴比伦<br/>Babylon]
    B --> B4[亚述<br/>Assyria]
    C --> C1[古王国<br/>Old Kingdom]
    C --> C2[中王国<br/>Middle Kingdom]
    C --> C3[新王国<br/>New Kingdom]
    D --> D1[哈拉帕<br/>Harappa]
    D --> D2[吠陀时期<br/>Vedic Period]
    E --> E1[夏商周<br/>Xia-Shang-Zhou]
    E --> E2[秦汉<br/>Qin-Han]
    F --> F1[奥尔梅克<br/>Olmec]
    F --> F2[玛雅<br/>Maya]
    G --> G1[阿契美尼德<br/>Achaemenid]
```
