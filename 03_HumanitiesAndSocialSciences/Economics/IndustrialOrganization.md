...
SCP范式（Structure-Conduct-Performance Paradigm）是产业组织学的经典分析框架：
...
**HHI指数**：$\text{HHI} = \sum s_i^2$，>2500为高度集中。
...
- **需求估计**：Berry-Levinsohn-Pakes（BLP）随机系数Logit模型
- **生产函数估计**：Olley-Pakes方法、Levinsohn-Petin方法
- **进入退出模型**：Bresnahan-Reiss模型、博弈估计
...
| 案例 | 涉及理论 | 政策含义 |
|------|----------|----------|
| 美国AT&T拆分 | 自然垄断、范围经济 | 放松管制促进竞争 |
| 微软反垄断案 | 捆绑销售、网络效应 | 技术垄断的边界 |
| 谷歌购物搜索案 | 搜索偏向、市场支配地位 | 数字平台反垄断 |
| 高通标准必要专利案 | FRAND承诺、专利劫持 | 知识产权与竞争政策 |
| 滴滴与Uber合并案 | 相关市场界定、经营者集中 | 平台经济并购审查 |
...
4. **实证阶段**：Stata/Python/R编程、实证研究论文写作、学术发表
