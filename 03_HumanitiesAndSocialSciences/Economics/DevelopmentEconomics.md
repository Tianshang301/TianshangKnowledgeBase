...
| 新制度主义 | 1990s 至今 | 制度质量、路径依赖 | 制度建设、治理改革 |
| 可持续发展 | 2000s 至今 | 包容性增长、绿色发展 | SDGs、减贫与环保 |
...
| Gini 系数 | $\frac{A}{A+B}$（洛伦兹曲线） | 仅反映收入不平等 |
...
$$
Y = A K^\alpha L^{1-\alpha}, \quad A = f(\text{R&D 支出}, \text{人力资本}, \text{制度质量})
$$
...
国际贫困线：每人每日生活支出低于2.15美元（2017年 PPP）。
...
| 区域合作 | 南南合作和区域一体化 | 一带一路、RCEP 等合作框架 |
