...
|----------|----------|------|
| 正方形| V = a³ | a 为棱 |
| 长方形| V = abc | a 为长，b 为宽，c 为高 |
| 圆柱 | V = πr²h | r 为底面半径，h 为高 |
| 圆锥 | V = ⅓πr²h | r 为底面半径，h 为高 |
...
|----------|------------|------|
| 正方形| S = 6a² | a 为棱 |
| 长方形| S = 2(ab+bc+ac) | a 为长，b 为宽，c 为高 |
| 圆柱 | S = 2πr² + 2πrh | r 为底面半径，h 为高 |
