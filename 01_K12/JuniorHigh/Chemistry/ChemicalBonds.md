...
水分子（H₂O）的形成：
H· + ·O· + ·H → H:O:H
两个 H 原子各提供一个电子，与 O 原子的两个电子形成共用电子对
```
...
```
配平：Fe₂O₃ + CO → Fe + CO₂
步骤：1. 观察 Fe：Fe₂O₃前配1，Fe 前配2
2. 观察 O：Fe₂O₃中有3个 O，CO 需3个 O
3. 观察 C：CO 前配3，CO₂前配3
