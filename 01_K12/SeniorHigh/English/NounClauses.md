...
```mermaid
flowchart TD
    A[Sentence<br/>句子] --> B[Noun Phrase<br/>The truth]
    A --> C[Noun Clause<br/>What he said]
    B --> D[Acts as subject,<br/>object, etc.]
    C --> D
    D --> E[Same grammatical<br/>function]
```
...
```mermaid
flowchart TD
    A[Connectors<br/>引导词] --> B[That<br/>无意义 只起连接]
    A --> C[Whether/if<br/>是否 表疑问]
    A --> D[Wh- words<br/>特殊疑问]
    D --> E[Who/whom<br/>人]
    D --> F[What/which<br/>事物]
    D --> G[When/where<br/>时间/地点]
    D --> H[Why/how<br/>原因/方式]
    D --> I[Whose<br/>所属]
```
