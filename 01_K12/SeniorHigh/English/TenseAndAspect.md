...
flowchart TD
    ...
    T --> N[现在 Present]
    T --> F[将来 Future]
    T --> PF[过去将来<br/>Past Future]

    P --> PP[一般过去/<br/>过去进行/<br/>过去完成/<br/>过去完成进行]
    N --> NN[一般现在/<br/>现在进行/<br/>现在完成/<br/>现在完成进行]
    F --> FF[一般将来/<br/>将来进行/<br/>将来完成/<br/>将来完成进行]
    PF --> PFF[过去将来时系列]
```
...
```mermaid
flowchart LR
    NP[现在完成时] --> |特点| NP1[强调对现在的影响]
    NP --> |特点| NP2[与现在时间相关]
    NP --> |时间状语| NP3[yet, already, since, for]

    SP[一般过去时] --> |特点| SP1[强调过去的动作本身]
    SP --> |特点| SP2[与现在无关]
    SP --> |时间状语| SP3[yesterday, last week, in 2020]
```
