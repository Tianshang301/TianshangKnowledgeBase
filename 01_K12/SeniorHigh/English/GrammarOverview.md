...
```mermaid
graph TD
  A[英语语法体系<br/>Grammar System] --> B[词法 Morphology<br/>Parts of Speech]
  A --> C[句法 Syntax<br/>Sentence Structure]
  B --> D[实词<br/>Content Words]
  B --> E[虚词<br/>Function Words]
  C --> F[简单句<br/>Simple Sentences]
  C --> G[复合句<br/>Complex Sentences]
  D --> H[名词 动词 形容词 副词 数词]
  E --> I[冠词 介词 连词 代词 感叹词]
  F --> J[主谓宾 主系表 等]
  G --> K[并列句 复合句]
...
```mermaid
graph TD
  A[名词性从句<br/>Noun Clauses] --> B[主语从句<br/>Subject Clause]
  A --> C[宾语从句<br/>Object Clause]
  A --> D[表语从句<br/>Predicative Clause]
  A --> E[同位语从句<br/>Appositive Clause]
  B --> F[That he won is true.]
  C --> G[I know what he did.]
  D --> H[The truth is that he lied.]
  E --> I[The fact that he won surprised us.]
```
