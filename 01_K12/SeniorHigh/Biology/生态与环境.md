...
**J 型增长**（Exponential Growth）：
$$ N_t = N_0 \lambda^t $$

- 条件：理想环境，食物空间充足，无天敌
- 特点：增长率不变，增长速率持续增大

**S 型增长**（Logistic Growth）：
...
| **水体富营养化** | N、P 过量排放 | 赤潮、水华 |
| **臭氧层破坏** | Freon 等排放 | UV 辐射增强 |
...
**碳汇**（Carbon Sink）：吸收 CO₂的生态系统（森林、海洋）
**碳源**（Carbon Source）：释放 CO₂的生态系统（燃烧、呼吸）
