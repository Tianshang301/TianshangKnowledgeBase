...
```mermaid
graph TD
  A["民主原则<br/>Democratic Principles"] --> B["主权在民<br/>Popular Sovereignty"]
  A --> C["多数原则<br/>Majority Rule"]
  A --> D["法治<br/>Rule of Law"]
  A --> E["权力制衡<br/>Checks & Balances"]
  A --> F["公民参与<br/>Civic Participation"]
  A --> G["政治平等<br/>Political Equality"]
  B --> H["选举与投票<br/>Elections"]
  C --> I["尊重少数<br/>Minority Rights"]
  D --> J["宪法至上<br/>Constitutional Supremacy"]
  E --> K["三权分立<br/>Separation of Powers"]
  F --> L["志愿/监督<br/>Volunteering/Oversight"]
  G --> M["一人一票<br/>One Person, One Vote"]
