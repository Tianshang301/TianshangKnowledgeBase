...
```mermaid
graph TD
  A["军事科学<br/>Military Science"] --> B["军事理论<br/>Military Theory"]
  A --> C["军事技术<br/>Military Technology"]
  A --> D["军事历史<br/>Military History"]
  A --> E["国防动员<br/>Defense Mobilization"]
  A --> F["联合作战<br/>Joint Operations"]
  B --> G["战略学<br/>Strategic Studies"]
  B --> H["战役学<br/>Operational Art"]
  B --> I["战术学<br/>Tactics"]
  C --> J["武器装备<br/>Weapon Systems"]
  C --> K["C4ISR<br/>军事信息化"]
  C --> L["网络/电子战<br/>Cyber/EW"]
  D --> M["中外战争史<br/>War History"]
  D --> N["军事思想史<br/>Military Thought"]
  E --> O["国民经济动员<br/>Economic Mobilization"]
  E --> P["民防体系<br/>Civil Defense"]
  F --> Q["军种协同<br/>Joint Synergy"]
  F --> R["联合指挥<br/>Joint Command"]
  style A fill:#4a3728,color:#fff
  style B fill:#6b4c3b,color:#fff
  style C fill:#6b4c3b,color:#fff
  style D fill:#6b4c3b,color:#fff
  style E fill:#6b4c3b,color:#fff
  style F fill:#6b4c3b,color:#fff
```
...
| 电子战 | 电子侦察、电子干扰、电子防护 | EA-18G咆哮者、综合电子战系统 |
...
| 联合指挥 | 联合司令部、任务式指挥、参谋作业 | NATO联合指挥结构 |
...
```mermaid
graph LR
  A["孙子兵法<br/>Sun Tzu"] --> D["不战而屈人之兵<br/>Supreme Excellence"]
  B["战争论<br/>Clausewitz"] --> E["战争是政治的延续<br/>War as Politics"]
  C["毛泽东军事思想<br/>Mao's Thought"] --> F["人民战争<br/>People's War"]
  D --> G["现代威慑理论<br/>Modern Deterrence"]
  E --> H["有限战争理论<br/>Limited War"]
  F --> I["总体防御/全民国防<br/>Total Defense"]
...
| 美国陆军FM系列野战条令 | 条令 | 涉及战术、后勤、作战 |
| 简氏防务周刊 (Janes Defence) | 资讯 | 全球防务动态 |
| RAND Corporation研究报告 | 智库 | 国防政策与分析 |
