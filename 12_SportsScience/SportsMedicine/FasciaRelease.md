...
```mermaid
graph TD
  A[筋膜系统<br/>Fascia System] --> B[力学功能<br/>Mechanical]
  A --> C[感觉功能<br/>Sensory]
  A --> D[代谢功能<br/>Metabolic]
  B --> E[力量传递<br/>Force Transmission]
  B --> F[弹性储能<br/>Elastic Energy Storage]
  C --> G[本体感觉<br/>Proprioception]
  C --> H[伤害感受<br/>Nociception]
  D --> I[组织液流动<br/>Interstitial Flow]
  D --> J[免疫细胞迁移<br/>Immune Cell Migration]
```
...
```mermaid
graph LR
  A[触诊定位<br/>Palpation] --> B[施加压力<br/>Apply Pressure]
  B --> C[等待释放<br/>Wait for Release 90-120s]
  C --> D{组织反应}
  D -->|松解感<br/>Tissue Release| E[缓慢移开<br/>Slow Release]
  D -->|无变化| F[调整角度/力度<br/>Adjust Vector/Force]
  F --> B
  E --> G[评估效果<br/>Re-assessment]
```
