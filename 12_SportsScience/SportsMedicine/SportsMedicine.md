...
```mermaid
mindmap
  root((运动医学<br/>Sports Medicine))
    损伤预防<br/>Prevention
      热身与拉伸<br/>Warm-up & Stretching
      防护装备<br/>Protective Gear
      负荷监控<br/>Load Monitoring
    诊断评估<br/>Diagnosis
      影像学<br/>Imaging
      功能评估<br/>Functional Assessment
      生物力学分析<br/>Biomechanics
    治疗手段<br/>Treatment
      保守治疗<br/>Conservative
      手术治疗<br/>Surgical
      药物治疗<br/>Pharmacological
    康复方案<br/>Rehabilitation
      阶段化训练<br/>Phased Training
      重返运动测试<br/>RTS Testing
      长期随访<br/>Long-term Follow-up
```
...
```mermaid
flowchart TD
    A[肩痛评估<br/>Shoulder Pain Assessment] --> B[病史与体格检查<br/>History & Physical]
    B --> C{疑似肩袖损伤<br/>Suspected RC Injury?}
    C -->|是 Yes| D[超声 / MRI 影像<br/>Ultrasound / MRI]
    C -->|否 No| E[其他诊断<br/>Other Diagnosis]
    D --> F[部分撕裂/肌腱炎<br/>Partial Tear/Tendinitis]
    D --> G[全层撕裂<br/>Full-thickness Tear]
    F --> H[保守治疗<br/>Conservative]
    G --> I{手术指征<br/>Surgical Indication?}
    I --> J[关节镜修复<br/>Arthroscopic Repair]
    H --> K[康复训练<br/>Rehabilitation]
    J --> K
```
