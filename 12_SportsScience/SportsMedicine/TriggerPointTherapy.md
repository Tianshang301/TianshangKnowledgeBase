...
```mermaid
flowchart TD
  A["患者主诉疼痛/功能受限<br/>Pain / Dysfunction"] --> B["病史采集 & 体态评估<br/>History & Postural Assessment"]
  B --> C["触诊检查<br/>Palpation Examination"]
  C --> D{"扪及紧张带 & 敏感结节<br/>Taut Band & Nodule?"}
  D -->|"是 Yes"| E["按压诱发引传痛<br/>Referred Pain Elicited?"]
  D -->|"否 No"| F["排除扳机点<br/>Rule Out TrP"]
  E -->|"是 Yes"| G["确诊活跃扳机点<br/>Active TrP Confirmed"]
  E -->|"否 No"| H["确诊潜伏扳机点<br/>Latent TrP Confirmed"]
  G --> I["评估引传痛模式<br/>Map Referred Pain Pattern"]
  I --> J["确定关键扳机点<br/>Identify Key TrP"]
  J --> K["制定治疗方案<br/>Treatment Plan"]
  H --> K
  F --> L["进一步鉴别诊断<br/>Differential Diagnosis"]
```
