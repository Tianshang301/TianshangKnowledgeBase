...
flowchart LR
    ...
    F --> H[痛觉敏化<br/>Hyperalgesia]
    G --> I[血管通透性↑<br/>Vascular Permeability]
    C --> J[溶酶体酶释放<br/>Lysosomal Enzymes]
    J --> K[蛋白水解<br/>Proteolysis]
```
...
```mermaid
flowchart LR
    A[运动后时间<br/>Post-Exercise Time] --> B[0-12h<br/>潜伏期<br/>Latent Phase]
    A --> C[12-24h<br/> onset<br/>症状出现]
    A --> D[24-72h<br/>高峰期<br/>Peak Soreness]
    A --> E[72-120h<br/>缓解期<br/>Resolution Phase]
    A --> F[>120h<br/>恢复期<br/>Recovery Phase]
    B --> G[肌酸激酶↑<br/>CK Elevation]
    C --> H[主观酸痛↑<br/>VAS ↑]
    D --> I[肌力最低点<br/>Max Strength Loss]
    E --> J[炎症消退<br/>Inflammation Subsides]
    F --> K[功能恢复<br/>Function Returns]
```
