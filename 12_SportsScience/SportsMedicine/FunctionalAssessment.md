...
```mermaid
graph TD
    A[功能性动作<br/>Functional Movement] --> B[灵活性<br/>Mobility]
    A --> C[稳定性<br/>Stability]
    A --> D[动作控制<br/>Motor Control]
    B --> B1[关节活动度<br/>ROM]
    B --> B2[软组织延展性<br/>Tissue Extensibility]
    C --> C1[核心稳定<br/>Core Stability]
    C --> C2[神经肌肉控制<br/>Neuromuscular Control]
    D --> D1[平衡<br/>Balance]
    D --> D2[本体感觉<br/>Proprioception]
```
...
```mermaid
graph LR
    A[功能障碍<br/>Dysfunction] --> B[活动度障碍<br/>MD]
    A --> C[稳定性/运动控制障碍<br/>SMCD]
    B --> B1[关节活动度受限<br/>JMD]
    B --> B2[组织延展性受限<br/>TED]
    C --> C1[神经发育模式异常<br/>DP]
    C --> C2[稳定性丧失<br/>LS]
...
```mermaid
graph TD
    A[初始访谈<br/>Initial Interview] --> B[主观评估<br/>Subjective]
    B --> C[静态姿势评估<br/>Postural Assessment]
    C --> D[移动性筛查<br/>Mobility Screen]
    D --> E[动作模式质量<br/>Movement Quality]
    E --> F[力量与爆发力<br/>Strength/Power]
    F --> G[运动专项测试<br/>Sport-Specific]
    G --> H[数据分析<br/>Data Analysis]
    H --> I[制定方案<br/>Intervention Plan]
    I --> J[再评估<br/>Re-assessment]
```
