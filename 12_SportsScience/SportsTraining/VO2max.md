...
```mermaid
flowchart TD
    A[VO₂max 训练体系<br/>VO₂max Training System] --> B[持续训练<br/>Continuous Training<br/>60-75% VO₂max]
    A --> C[间歇训练<br/>Interval Training<br/>90-100% VO₂max]
    A --> D[高原训练<br/>Altitude Training<br/>2000-3000m]
    A --> E[力量耐力<br/>Strength Endurance<br/>Circuit/Complex]
    B --> F[增加 SV<br/>↑ Stroke Volume]
    C --> G[提高心脏泵血能力<br/>↑ Cardiac Output]
    D --> H[促进 EPO<br/>↑ Erythropoiesis]
    E --> I[提升跑步经济性<br/>↑ Running Economy]
```
