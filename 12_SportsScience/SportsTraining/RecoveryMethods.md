...
```mermaid
flowchart TD
    RM[恢复方法<br/>Recovery Methods] --> AR[主动恢复<br/>Active Recovery]
    RM --> PR[被动恢复<br/>Passive Recovery]
    RM --> NR[营养恢复<br/>Nutritional Recovery]
    RM --> SR[睡眠恢复<br/>Sleep Recovery]
    RM --> PRY[心理恢复<br/>Psychological Recovery]
    RM --> PHYS[物理恢复<br/>Physical Therapy]
    AR --> AR1[低强度有氧运动<br/>Low-Intensity Cardio]
    AR --> AR2[柔韧性训练<br/>Flexibility Training]
    PR --> PR1[冷疗: 冷水浸泡/CWI<br/>Cold Therapy]
    PR --> PR2[热疗: 桑拿/热水浴<br/>Heat Therapy]
    PR --> PR3[冷热水交替/CWT<br/>Contrast Therapy]
    PHYS --> PH1[泡沫轴滚压<br/>Foam Rolling]
    PHYS --> PH2[筋膜枪/冲击疗法<br/>Percussive Therapy]
    PHYS --> PH3[压缩衣物<br/>Compression Garments]
