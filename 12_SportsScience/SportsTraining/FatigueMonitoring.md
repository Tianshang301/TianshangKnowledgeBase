...
```mermaid
graph TD
    subgraph 恢复层次 Recovery Hierarchy
        A[每日恢复 Daily Recovery<br/>睡眠 + 营养 + 主动恢复] --> B[每周恢复 Weekly Recovery<br/>低负荷日 + 完全休息日]
        B --> C[阶段恢复 Block Recovery<br/>减量周 Deload Week]
        C --> D[赛季末恢复 End of Season<br/>主动休息期 Active Rest 2-4周]
    end
```
