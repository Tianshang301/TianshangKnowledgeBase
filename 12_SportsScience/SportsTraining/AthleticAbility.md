...
```mermaid
graph LR
    subgraph 敏感窗口期 Sensitive Windows
        A[5-7岁 灵敏性 Agility] --> B[8-10岁 速度 Speed]
        B --> C[10-12岁 力量 Strength<br/>女孩先于男孩]
        C --> D[12-14岁 有氧耐力<br/>Aerobic Endurance]
        D --> E[14-16岁 最大力量<br/>Max Strength<br/>男孩高峰期]
    end
```
...
```mermaid
graph LR
    subgraph 速度构成 Speed Components
        A[反应速度<br/>Reaction Time] --> B[加速阶段<br/>Acceleration 0-10m]
        B --> C[最大速度阶段<br/>Max Velocity 10-30m]
        C --> D[速度维持/减速<br/>Speed Endurance]
    end
```
