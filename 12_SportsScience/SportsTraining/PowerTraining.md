...
```mermaid
graph LR
    subgraph 力量-速度曲线 Force-Velocity Curve
        A[最大力量区域<br/>Max Strength Zone<br/>>85% 1RM<br/>慢速] --> B[力量-爆发力区域<br/>Strength-Power Zone<br/>70-85% 1RM<br/>中速]
        B --> C[爆发力区域<br/>Power Zone<br/>30-70% 1RM<br/>中-高速]
        C --> D[速度-爆发力区域<br/>Speed-Strength Zone<br/><30% 1RM<br/>高速]
    end
```
...
```mermaid
graph TD
    subgraph 年度周期 Annual Periodization
        A[准备期<br/>Preparation<br/>12-16周<br/>最大力量 + 技术基础] --> B[第一过渡期<br/>Transition I<br/>4-8周<br/>力量-爆发力转化]
        B --> C[赛前期<br/>Pre-Competition<br/>4-8周<br/>专项爆发力峰值]
        C --> D[比赛期<br/>Competition<br/>8-16周<br/>爆发力维持]
        D --> E[过渡期<br/>Active Rest<br/>2-4周<br/>主动恢复]
        E --> A
    end
```
