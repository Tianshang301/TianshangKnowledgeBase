...
```mermaid
flowchart TD
    A[体育科学<br/>Sports Science] --> B[运动人体科学]
    A --> C[体育人文社会学]
    A --> D[体育教育训练学]
    A --> E[民族传统体育学]
    B --> F[运动解剖学]
...
```mermaid
flowchart LR
    A[运动心理<br/>Sport Psychology] --> B[动机 Motivation]
    A --> C[焦虑与唤醒 Anxiety]
    A --> D[注意与专注 Attention]
    A --> E[自信心 Confidence]
    A --> F[团队动力 Team Dynamics]
    A --> G[心理技能训练 PST]
    G --> H[目标设定 Goal Setting]
    G --> I[表象训练 Imagery]
    G --> J[自我谈话 Self-talk]
    G --> K[放松技巧 Relaxation]
```
...
```mermaid
flowchart TD
    A[周期化训练<br/>Periodization] --> B[大周期 Macrocycle]
    A --> C[中周期 Mesocycle]
    A --> D[小周期 Microcycle]
    B --> E[准备期 Preparation]
    B --> F[比赛期 Competition]
