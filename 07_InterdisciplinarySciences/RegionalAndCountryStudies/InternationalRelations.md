...
```mermaid
graph TD
  A["国际关系理论<br/>IR Theories"] --> B["主流理论<br/>Mainstream"]
  A --> C["批判理论<br/>Critical Theories"]
  B --> D["现实主义<br/>Realism"]
  B --> E["自由主义<br/>Liberalism"]
  B --> F["建构主义<br/>Constructivism"]
  C --> G["马克思主义<br/>Marxism"]
  C --> H["女性主义<br/>Feminism"]
  C --> I["后殖民主义<br/>Postcolonialism"]
  C --> J["绿色理论<br/>Green Theory"]
  D --> K["古典现实主义<br/>Classical Realism"]
  D --> L["新现实主义<br/>Neorealism"]
  D --> M["进攻性现实主义<br/>Offensive Realism"]
  D --> N["防御性现实主义<br/>Defensive Realism"]
  E --> O["自由国际主义<br/>Liberal Internationalism"]
  E --> P["共和自由主义<br/>Republican Liberalism"]
  E --> Q["商业自由主义<br/>Commercial Liberalism"]
  F --> R["规范扩散<br/>Norm Diffusion"]
  F --> S["身份政治<br/>Identity Politics"]
