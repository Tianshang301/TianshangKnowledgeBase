...
基于分子系统学（Molecular Phylogenetics）的最新分类系统（APG IV 系统）重建了被子植物的演化关系：
...
Whittaker 生物群系图显示，年均温和年降水量共同决定群系类型：
...
植物间竞争资源（光、水、养分），Lotka-Volterra 竞争模型：
...
CO₂浓度升高可能产生 CO₂施肥效应（CO₂ Fertilization Effect），但伴随的温度升高和干旱加剧可能抵消此效应。
