...
```mermaid
flowchart TD
    PT[物理治疗] --> MSK[肌肉骨骼 Musculoskeletal]
    PT --> NEU[神经康复 Neurological]
    PT --> CAR[心肺康复 Cardiopulmonary]
    PT --> GER[老年康复 Geriatric]
    PT --> PED[儿童康复 Pediatric]
    PT --> SPO[运动康复 Sports]
    PT --> WOM[女性健康 Women's Health]
