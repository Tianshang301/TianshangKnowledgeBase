...
```mermaid
graph TD
  A["医学与健康<br/>Medicine & Health"] --> B["基础医学<br/>Basic Medicine"]
  A --> C["临床医学<br/>Clinical Medicine"]
  A --> D["公共卫生<br/>Public Health"]
  A --> E["药学<br/>Pharmacy"]
  A --> F["护理与康复<br/>Nursing & Rehab"]
  B --> G["人体解剖学<br/>Anatomy"]
  B --> H["生理学<br/>Physiology"]
  B --> I["病理学<br/>Pathology"]
  B --> J["药理学<br/>Pharmacology"]
  B --> K["免疫学<br/>Immunology"]
  C --> L["内科学<br/>Internal Medicine"]
  C --> M["外科学<br/>Surgery"]
  C --> N["妇产科学<br/>OB/GYN"]
  C --> O["儿科学<br/>Pediatrics"]
  C --> P["神经病学<br/>Neurology"]
  D --> Q["流行病学<br/>Epidemiology"]
  D --> R["卫生统计学<br/>Biostatistics"]
  D --> S["环境卫生<br/>Env. Health"]
  D --> T["健康政策<br/>Health Policy"]
  E --> U["药物化学<br/>Medicinal Chem"]
  E --> V["药剂学<br/>Pharmaceutics"]
  E --> W["临床药学<br/>Clinical Pharmacy"]
  F --> X["基础护理<br/>Fundamental Nursing"]
  F --> Y["康复医学<br/>Rehab Medicine"]
  F --> Z["社区护理<br/>Community Nursing"]
...
```mermaid
graph LR
  A["高考<br/>Gaokao"] --> B["医学本科 5年<br/>MBBS / MD-equivalent"]
  B --> C["住院医师规培 3年<br/>Residency"]
  C --> D["专科医师培训 2~4年<br/>Fellowship"]
  D --> E["主治医师<br/>Attending"]
  E --> F["副主任/主任医师<br/>Senior Consultant"]
  B --> G["科研硕士/博士 3~6年<br/>MSc/PhD"]
  G --> H["基础/临床研究员<br/>Researcher"]
  C --> I["全科医师<br/>GP/Family Doctor"]
