...
DevOps是Development和Operations的组合，旨在打破开发与运维之间的壁垒。
...
持续部署（CD）是CI的延伸，将通过测试的代码自动部署到生产环境。
...
| CloudFormation | AWS专用 | 声明式 | 有 | AWS |
