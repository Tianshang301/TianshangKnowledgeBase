...
| 集成测试 | 秒级 | 中 | 接口问题 | 中 |
| E2E 测试 | 分钟级 | 高 | 流程问题 | 低 |
| 手动测试 | 小时级 | 极高 | UX 问题 | 不定 |

## 二、单元测试框架

主流单元测试框架对比：

| 语言 | 框架 | 断言风格 | Mock 支持 | 覆盖率工具 |
|------|------|----------|----------|-----------|
...
2. 《xUnit 测试模式》Gerard Meszaros 著
3. Jest 官方文档：https://jestjs.io
4. pytest 官方文档：https://docs.pytest.org
5. Cypress 端到端测试指南：https://docs.cypress.io
6. Selenium WebDriver 文档：https://www.selenium.dev/documentation
7. OWASP 安全测试指南
