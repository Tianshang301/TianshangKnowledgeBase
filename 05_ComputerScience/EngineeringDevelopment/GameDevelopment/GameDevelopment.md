...
| Custom Engine | C/C++ | 开发成本高 | 自定 | 使命召唤, FIFA |
...
| 技术 | 原理 | 应用 |
|------|------|------|
| 有限状态机 (FSM) | 状态 + 转移条件 | NPC 行为: 巡逻→追逐→攻击→巡逻 |
