...
```mermaid
flowchart TD
    MUS[音乐学<br/>Musicology] --> HIST[历史音乐学<br/>Historical Musicology]
    MUS --> SYS[系统音乐学<br/>Systematic Musicology]
    MUS --> ETH[民族音乐学<br/>Ethnomusicology]
    MUS --> POP[流行音乐研究<br/>Popular Music Studies]

    HIST --> H1[西方艺术音乐史]
    HIST --> H2[音乐文献与手稿]
    HIST --> H3[音乐传记与风格分析]
    HIST --> H4[表演实践<br/>Historical Performance]

    SYS --> S1[音乐理论<br/>Music Theory]
    SYS --> S2[音乐声学<br/>Acoustics]
    SYS --> S3[音乐心理学<br/>Psychology of Music]
    SYS --> S4[音乐社会学<br/>Sociology of Music]
    SYS --> S5[音乐美学<br/>Aesthetics]

    ETH --> E1[世界音乐研究]
    ETH --> E2[田野调查<br/>Fieldwork]
    ETH --> E3[文化语境分析]
    ETH --> E4[乐器学<br/>Organology]
```
