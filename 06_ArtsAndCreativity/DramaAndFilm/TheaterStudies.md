...
```mermaid
flowchart TD
    A[Theatrical<br/>Event] --> B[Playwright<br/>Text creation]
    A --> C[Director<br/>Interpretation]
    A --> D[Actor<br/>Embodiment]
    A --> E[Audience<br/>Reception]
    B --> F[Cocreation<br/>of meaning]
    C --> F
    D --> F
    E --> F
```
...
```mermaid
flowchart LR
    A[Act 1<br/>Setup] --> B[Plot Point 1<br/>Inciting Incident]
    B --> C[Act 2<br/>Confrontation]
    C --> D[Midpoint<br/>Crisis]
    D --> E[Plot Point 2<br/>All is Lost]
    E --> F[Act 3<br/>Resolution]
    F --> G[Climax →<br/>Denouement]
```
...
```mermaid
flowchart TD
    A[Major Acting<br/>Systems] --> B[Stanislavski<br/>System]
    A --> C[Brecht<br/>Epic Theater]
    A --> D[Meyerhold<br/>Biomechanics]
    B --> E[Emotional Memory<br/>Psychological realism]
    B --> F[Magic If<br/>Given circumstances]
    C --> G[Alienation Effect<br/>Verfremdungseffekt]
    C --> H[Breaking fourth wall<br/>Direct address]
    D --> I[Physical training<br/>Biomechanical exercises]
    D --> J[Constructivist<br/>performance]
```
...
```mermaid
flowchart TD
    A[Director<br/>Vision] --> B[Script Analysis<br/>文本分析]
    A --> C[Concept Development<br/>概念构思]
    A --> D[Casting<br/>选角]
    A --> E[Rehearsal<br/>排练]
    A --> F[Design Coordination<br/>舞美协调]
    E --> G[Blocking<br/>舞台调度]
    E --> H[Character Work<br/>角色塑造]
    E --> I[Tempo/Rhythm<br/>节奏把控]
    F --> J[Set + Costume<br/>+ Lighting + Sound]
```
...
```mermaid
flowchart LR
    A[Western<br/>Theater] -->|Influence| B[Modern Chinese<br/>Drama Huaju]
    A -->|Influence| C[Japanese<br/>Shingeki]
    D[Beijing Opera<br/>Jingju] -->|Influence| E[Brecht<br/>Epic Theater]
    F[Noh<br/>能乐] -->|Influence| G[Yeats,<br/>Claudel]
    H[Kathakali] -->|Influence| I[Eugenio Barba<br/>Theatre Anthropology]
```
