...
```mermaid
timeline
    title Film Theory Timeline
    1910s : Formalist Theory<br/>Münsterberg
    1920s : Montage Theory<br/>Eisenstein, Kuleshov
    1930s : Realist Theory<br/>Bazin, Kracauer
    1960s : Auteur Theory<br/>Cahiers du Cinéma
    1970s : Apparatus Theory<br/>Screen theory
    1980s : Postmodern<br/>and beyond
```
...
```mermaid
flowchart TD
    A[Montage<br/>Types] --> B[Metric<br/>Based on shot length]
    A --> C[Rhythmic<br/>Based on movement]
    A --> D[Tonal<br/>Based on emotional tone]
    A --> E[Overtonal<br/>Combination of above]
    A --> F[Intellectual<br/>Abstract concepts]
    B --> G[Pure timing<br/>Indep of content]
    C --> H[Cut on action<br/>within frame]
    D --> I[Lighting, color<br/>emotional quality]
    E --> J[Synthesis of<br/>metric+rhythmic+tonal]
    F --> K[Dialectical<br/>thesis + antithesis]
```
...
```mermaid
flowchart TD
    A[Autonomous<br/>Segment] --> B[Autonomous Shot<br/>单镜头]
    A --> C[Syntagmatic<br/>组合段]
    C --> D[Chronological<br/>时序性]
    C --> E[A-Chronological<br/>非时序]
    D --> F[Narrative<br/>叙事性]
    D --> G[Descriptive<br/>描述性]
    F --> H[Alternating<br/>交替]
    F --> I[Linear<br/>线性]
```
...
```mermaid
flowchart TD
    A[Cinematic Gaze<br/>三重凝视] --> B[Camera Gaze<br/>摄影机/导演]
    A --> C[Character Gaze<br/>男性角色]
    A --> D[Spectator Gaze<br/>观众（男性预设）]
    B --> E[控制观看<br/>位置]
    C --> F[叙事中的<br/>观看权力]
    D --> G[通过认同<br/>获得满足]
```
