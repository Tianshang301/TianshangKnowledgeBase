...
```mermaid
graph LR
    A[旧石器<br/>Paleolithic] -->|狩猎采集| B[洞穴壁画<br/>Cave Painting]
    B -->|动物主题| C[写实风格<br/>Naturalism]
    A --> D[新石器<br/>Neolithic]
    D -->|农业定居| E[陶器与建筑<br/>Pottery/Architecture]
    E -->|几何纹样| F[抽象图案<br/>Abstraction]
```
...
```mermaid
graph TD
    A[中世纪<br/>Medieval] -->|神本主义| B[宗教艺术<br/>Religious Art]
    B -->|人文主义转型| C[文艺复兴<br/>Renaissance]
    C -->|透视法| D[空间再现<br/>Spatial Representation]
    C -->|解剖学| E[人体写实<br/>Naturalistic Figure]
    C -->|古典复兴| F[古希腊罗马<br/>Greco-Roman Revival]
```
...
```mermaid
graph LR
    A[印度佛教艺术<br/>Indian Buddhist Art] -->|经中亚| B[敦煌莫高窟<br/>Dunhuang Mogao Caves]
    B -->|本土化| C[中国佛教艺术<br/>Chinese Buddhist Art]
    C -->|东传| D[日本佛教艺术<br/>Japanese Buddhist Art]
```
