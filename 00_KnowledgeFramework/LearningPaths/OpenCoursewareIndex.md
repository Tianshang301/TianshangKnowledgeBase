...
```mermaid
flowchart TD
  A[开始选课<br/>Start Course Selection] --> B{学习目标是什么?<br/>What is your goal?}
  B -->|系统化学位<br/>Degree-oriented| C[OSSU / edX / Coursera<br/>完整学位路径]
  B -->|技能提升<br/>Skill improvement| D[Fast.ai / Kaggle / Udacity<br/>项目驱动学习]
  B -->|概念理解<br/>Concept understanding| E[3Blue1Brown / StatQuest<br/>可视化概念讲解]
  B -->|应试准备<br/>Exam preparation| F[Coding Interview University<br/>面试系统学习]
  C --> G[制定学习计划<br/>Create Study Plan]
  D --> G
  E --> G
  F --> G
  G --> H[开始学习<br/>Start Learning]
  H --> I[做笔记 + 完成作业<br/>Note-taking + Assignments]
  I --> J[参与社区讨论<br/>Join Discussions]
  J --> K[获取证书 / 构建作品集<br/>Certification / Portfolio]
```
