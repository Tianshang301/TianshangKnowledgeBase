...
tags: ['AerospaceAndMilitaryEngineering', 'AerospaceEngineering', 'Astrodynamics.md']
created: 2026-05-17
updated: 2026-05-17
---
...
### 13.1 N 体问题 (N-Body Problem)

N 体问题无通用解析解。 \geq 3$ 时只能数值积分 (Numerical Integration)。
...
| Runge-Kutta-Nystrom (RKN) | 4/6 | 直接积分二阶 ODE | 无摄动轨道 |
